...
<div class="calculator">
  ...
  <div class="numpers">
    ...
    <button id="back-space"><ion-icon name="arrow-back"></ion-icon></button>
    <button id="dot">.</button>
    <button id="multi"><ion-icon name="close"></ion-icon></button>
    ...
    <button id="minus"><ion-icon name="remove"></ion-icon></button>
    <button id="one">1</button>
    <button id="two">2</button>
    <button id="three">3</button>
    <button id="plus"><ion-icon name="add"></ion-icon></button>
    <button id="zero">0</button>
    <button id="modulus">%</button>
    <button id="equal"><ion-icon name="reorder-two"></ion-icon></button>
  </div>
</div>
</div>
`
